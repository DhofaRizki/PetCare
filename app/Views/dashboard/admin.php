...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="#admin" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Admin</span></a></li>      
  ...
  <section id="home" class="d-flex flex-column justify-content-center">
    ...
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1 align="left">PET CARE</h1>
      <p><h2 align="left"><span class="typed" data-typed-items="Grooming, Doctor, Pet Stuff"></span></h2></p>
    ...
    <section class="About" id="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2 >About</h2>
          <p>Hard to find the neearest petshop? We can help you, this web help you to find the nearest Petshop </p>
          <p>
            Our website purpose is to help many people that who cant find the nearest Petshop around them,
          </p>
          <p>so we make it to help people that have Pet at their home to find the nearest Petshop</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="452.984" data-purecounter-duration="1" class="purecounter"></span>
              <p>Have Pet</p>
            </div>
          </div>
...
<section id="services" class="services">
  <div class="container" data-aos="fade-up">
    ...
    <section id="admin" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <br>
        <p align="center">U're an Admin Now</p>
        <div class="social-auth-links text-center mt-2 mb-3">
        <a href="/dashboard/maintenance" class="btn btn-primary">
                Maintenance
        </a>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Pet Care</span></strong>. All Rights Reserved
      </div>
      <div class="credits">

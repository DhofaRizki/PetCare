...
<form method="post" action="<?=base_url('/signup/Save')?>">
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card">
      <div class="card text-white bg-secondary mb-3">
            <div align="center" class="card-header">Sign Up</div>
            <div class="card-body">
            ...
            <div class="form-group row">
                <label for="katasandi" class="col-sm-4 col-form-label">Password</label>
                <div class="col-sm-6">
